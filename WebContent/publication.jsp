...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/publicationpage.css">
			...
			<a href="publicationdetailpage.html">
				<div class="entry">
					<div class="one columns thumbnail">
						<img src="${pageContext.request.contextPath}/images/Publication/noimage.jpg">
					</div>
